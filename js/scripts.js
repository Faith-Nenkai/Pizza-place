...
$(document).ready(function () {
  $('form[name="details"]').submit(function (event) {
    var quantity = parseInt($("#quantity").val());
    var type = parseInt($("#type").val());
    var crust = parseInt($("#crust").val());
    var toppings = parseInt($("#toppings").val());
    var moreToppings = parseInt($("#moreToppings").val());

    var pizzaOrder = new PizzaOrder(quantity, type, crust, toppings, moreToppings)

    $("#detailsPrice").html(pizzaOrder.orderPrice())
    event.preventDefault()
  })
})
function PizzaOrder(quantity, pizzaType, pizzaCrust, pizzaToppings, moreToppings) {
...
PizzaOrder.prototype.orderPrice = function () {
  var total = this.quantity * (this.type + this.crust + this.toppings + this.moreToppings)
  return total;
}
function choose() {
  var a, b, c, d;
